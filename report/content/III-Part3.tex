...
\begin{itemize}
    \item[-] Địa chỉ MAC của router/gateway : 54-04-63-2f-d7-6c
    \item[-] Địa chỉ MAC hiện thị qua Wireshark:
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{img/3-cau3-1.png}
        \caption{Địa chỉ MAC trong Ethernet Header của DNS Query}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \caption{Địa chỉ MAC trong Command Prompt}
    \end{figure}
\end{itemize}
...
\begin{itemize}
    \item[-] Địa chỉ của nguồn và đích trong tiêu đề của tầng Link được hiển thị dưới dạng địa chỉ MAC:
    \begin{itemize}
        \item[$\bullet$] Địa chỉ nguồn: 48:e7:da:a9:98:3b
        \item[$\bullet$] Địa chỉ đích: 54:04:63:2f:d7:6c
    \end{itemize}
    \begin{figure}[H]
        \centering
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{3cm}|p{8cm}|p{7cm}|}
        \hline
        \multicolumn{1}{|c|}{\textbf{Đặc điểm}} & \multicolumn{1}{c|}{\textbf{Địa chỉ MAC}} & \multicolumn{1}{c|}{\textbf{Địa chỉ IP}} \\
        \hline
        Tầng mạng & Tầng 2 - Data Link (OSI) & Tầng Network (TCP/IP) \\
        \hline
...
\subsubsection{What is the Type field's value}
...
\subsubsection{What does it tell the receiving device (your router/gateway) about the protocol that follows}
